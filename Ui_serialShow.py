...
class Ui_SerialShow(object):
    def setupUi(self, SerialShow):
        ...
        self.comboBox_chooseposture = QtWidgets.QComboBox(parent=self.widget_5)
        font = QtGui.QFont()
        font.setPointSize(15)
        ...
        self.comboBox_predictPos = QtWidgets.QComboBox(parent=self.widget_10)
        font = QtGui.QFont()
        font.setPointSize(15)
        ...
        self.pushButton_cleckcoms = QtWidgets.QPushButton(parent=self.widget_8)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pushButton_cleckcoms.sizePolicy().hasHeightForWidth())
        self.pushButton_cleckcoms.setSizePolicy(sizePolicy)
        self.pushButton_cleckcoms.setMinimumSize(QtCore.QSize(0, 34))
        font = QtGui.QFont()
        font.setPointSize(15)
        self.pushButton_cleckcoms.setFont(font)
        self.pushButton_cleckcoms.setObjectName("pushButton_cleckcoms")
        self.horizontalLayout_3.addWidget(self.pushButton_cleckcoms)
        self.comboBox_Coms = QtWidgets.QComboBox(parent=self.widget_8)
        ...
        self.horizontalLayout_3.addWidget(self.comboBox_Coms)
    ...
    def retranslateUi(self, SerialShow):
        ...
        self.pushButton_cleckcoms.setText(_translate("SerialShow", "检测串口"))
