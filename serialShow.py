...
class Ui_SerialShow(object):
    def setupUi(self, SerialShow):
        ...
        self.spinBox_IInterval = QtWidgets.QSpinBox(parent=self.widget_10)
        font = QtGui.QFont()
        font.setPointSize(15)
        self.spinBox_IInterval.setFont(font)
        self.spinBox_IInterval.setMinimum(1)
        self.spinBox_IInterval.setMaximum(10)
        self.spinBox_IInterval.setObjectName("spinBox_IInterval")
        self.gridLayout_10.addWidget(self.spinBox_IInterval, 1, 1, 1, 1)
        ...
        self.spinBox_SInterval = QtWidgets.QSpinBox(parent=self.widget_10)
        font = QtGui.QFont()
        font.setPointSize(15)
        self.spinBox_SInterval.setFont(font)
        self.spinBox_SInterval.setMinimum(1)
        self.spinBox_SInterval.setMaximum(10)
        self.spinBox_SInterval.setObjectName("spinBox_SInterval")
        self.gridLayout_10.addWidget(self.spinBox_SInterval, 2, 1, 1, 1)
        ...
        self.menubar = QtWidgets.QMenuBar(parent=SerialShow)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1300, 22))
        self.menubar.setObjectName("menubar")
        SerialShow.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(parent=SerialShow)
    ...
    def retranslateUi(self, SerialShow):
        ...
        self.comboBox_2.setItemText(0, _translate("SerialShow", "高位"))
        self.comboBox_2.setItemText(1, _translate("SerialShow", "低位"))
        self.label_7.setText(_translate("SerialShow", "设置红外采样帧间隔："))
        self.label_8.setText(_translate("SerialShow", "设置超声采样帧间隔："))
        self.pushButton.setText(_translate("SerialShow", "保存实时数据"))
